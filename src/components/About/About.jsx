...
export const About = () => {
  return (
    <section className='about' id='mechanics'>
      ...
      <p className="about__description">Для участия необходимо провести акцептование в период с 05.08.2023 по 31.10.2023в Мобильном приложении «АЗС ЛУКОЙЛ» в карточке акции «Марафон кофе».</p>
    </section>
  )
}